...
> 如果我们没有标签数据，只知道它们是多个高斯分布的混合  
>    - 现实生活中的很多变量，都可以看作n个高斯分布的混合。
>    - 所以这是个很合理的假设 

此时就无法通过**最大似然估计**，直接来估算参数了  
怎么办呢？还有**EM算法**
...
1. 随机初始化两个高斯分布$\mu_A、\sigma_A、P_A、\mu_B、\sigma_B、P_B$
    - 类似于**k-means**中，我们先随机选择两个簇类中心
2. 重复这两步直到收敛
...
> 而是介绍了一下对于**高斯混合模型**，如何使用**EM算法**来做**参数估计**